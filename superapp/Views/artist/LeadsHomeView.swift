...
// Stub for the lead client model
struct LeadClient: Identifiable {
    let id: String
    let name: String
...
struct AvatarView: View {
    ...
    var body: some View {
        ZStack {
            Circle().fill(Theme.Colors.accent.gradient)
            Text(initials)
...
struct InkBackground: View {
    var body: some View {
        LinearGradient(colors: [Theme.Colors.background, Theme.Colors.surface],
